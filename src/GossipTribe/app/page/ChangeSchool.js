...
export default class ChangeSchool extends Component{

      constructor(props){
        super(props);
        this.state = {
          nameValue:this.props.trainSchool,
          deleteIconWidth:this.props.trainSchool?20:0,
          deleteIconHeight:this.props.trainSchool?20:0,
        }
      }
      ...
      _save(){
        this.props.changeSchool(this.state.nameValue);
        let _navigator = this.props._navigator;
        if(_navigator&&_navigator.getCurrentRoutes().length>1){
              _navigator.pop();
        }
